...
import { toolDoneLabel, toolLabel, toolMetaName } from '../lib/toolCopy'
          ...
          <div className="toolbox">
            {msg.tools.filter((t) => t.status === 'done').map((t) => (
              <div className="tool-done" key={t.id}>
                ...
                <span>{ipc.prefix} {toolDoneLabel(ipc, t.name)}</span>
                {showToolDetails && <span className="tool-done__meta">{toolMetaName(t.name)}</span>}
              </div>
            ))}
            {runningTool && (
              <div className="toolcard">
                ...
                <div className="toolcard__info">
                  <div className="toolcard__label"><strong>{ipc.prefix} {toolLabel(ipc, runningTool.name)}</strong></div>
                  <div className="goldline" />
                  <div className="toolcard__meta">
                    {showToolDetails ? `${toolMetaName(runningTool.name)} · ${runningTool.argsPreview}` : toolMetaName(runningTool.name)}
                  </div>
                </div>
              </div>
            )}
